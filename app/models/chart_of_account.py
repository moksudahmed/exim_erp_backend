...
class ChartOfAccount(Base):
    ...
    journal_entries_entries = relationship("JournalEntry", back_populates="chart_of_account")
    journal_items = relationship("JournalItems", back_populates="chart_of_account")
